...
public class HotOrNot {
	...
	public String getHotness(Long mylong) throws SQLException {
		// TODO Auto-generated method stub
		String[] columns = new String[] { KEY_ROWID, KEY_NAME, KEY_HOTNESS };
		Cursor c = ourDatabase.query(DATABASE_TABLE, columns, KEY_ROWID + "=" + mylong, null, null, null, null);
		if (c != null) {
			c.moveToFirst();
	...
	public String getName(Long mylong) throws SQLException {
		// TODO Auto-generated method stub
		String[] columns = new String[] { KEY_ROWID, KEY_NAME, KEY_HOTNESS };
		Cursor c = ourDatabase.query(DATABASE_TABLE, columns, KEY_ROWID + "=" + mylong, null, null, null, null);
		if (c != null) {
